        ...
        switch (v.getId()){
            case R.id.btn_lib:
                ...
                if (!TextUtils.isEmpty(TEXT_NATIVE)){
                    url = Constants.LIBRARY_NATIVE+TITLE+ Constants.LIBRARY_NATIVE_TEXT+TEXT_NATIVE+ Constants.LIBRARY_NATIVE_TYPE+TYPE;
            ...
            case R.id.btn_baidu:               //百度一下
                ...
                if (!TextUtils.isEmpty(TEXT_BAIDU)){
                    url = Constants.BAIDU_ACADEMIC+TEXT_BAIDU+ Constants.BAIDU_TEXT;
                    Intent intent = new Intent(this,WebInfoActivity.class);
                    intent.putExtra("url",url);
                    startActivity(intent);
                }else {
