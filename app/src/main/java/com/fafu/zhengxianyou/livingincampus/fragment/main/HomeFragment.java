...
import com.fafu.zhengxianyou.livingincampus.adapter.home.HomeFragmentAdapter;
...
public class HomeFragment extends BaseFragment{
    ...
    private void getJson() {
        ...
        try {
            URL   url = new URL(Constants.FAFU);
    ...
    private void getFocus() {
        ...
        try {
            Document document = Jsoup.connect(Constants.FOCUS).get();
    ...
    private void getAnnouncement() {
        ...
        try {
            Document document = Jsoup.connect(Constants.ANNOUNCEMENT).get();
            Element element = document.getElementById("wp_news_w3");
            Elements links = element.getElementsByTag("a");
            for (Element link:links){
                String href = link.attr("href");
    ...
    private void getCampusCulture() {
        ...
        try {
            Document document = Jsoup.connect(Constants.CAMPUS_CULTURE).get();
            Element element = document.getElementById("wp_news_w3");
            Elements links = element.getElementsByTag("a");
            for (Element link:links){
                String href = link.attr("href");
    ...
    private void getCollegeTends() {
        ...
        try {
            Document document = Jsoup.connect(Constants.COLLEGE_TENDS).get();
            Element element = document.getElementById("wp_news_w3");
            Elements links = element.getElementsByTag("a");
            for (Element link:links){
                String href = link.attr("href");
    ...
    private void getAcademicTends() {
        ...
        try {
            Document document = Jsoup.connect(Constants.ACADEMIC_TENDS).get();
            Element element = document.getElementById("wp_news_w3");
            Elements links = element.getElementsByTag("a");
            for (Element link:links){
                String href = link.attr("href");
