...
import com.fafu.zhengxianyou.livingincampus.route.RouteActivity;
...
public class PoiAroundSearchActivity extends Activity implements View.OnClickListener,
    ...
    private LatLonPoint lp = new LatLonPoint(Config.getLatitude(),Config.getLongitude());//地图中心点
    ...
    private void setup() {
        ...
        mPoiDetail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
				Intent intent = new Intent(PoiAroundSearchActivity.this,
						RouteActivity.class);
        ...
        mSearchText = (EditText)findViewById(R.id.actv_input);
    }
    ...
    protected void doSearchQuery() {
        keyWord = Config.getCityName()+mSearchText.getText().toString().trim();
        currentPage = 0;
...
//            poiSearch.setBound(new PoiSearch.SearchBound(lp, 10000, true));//
            ...
            if (result != null && result.getQuery() != null) {// 搜索poi的结果
                if (result.getQuery().equals(query)) {// 是否是同一条
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        Utils.toast(PoiAroundSearchActivity.this,
                                R.string.no_result);
                    }
                }
            } else {
    ...
    private void setPoiItemDisplayContent(final PoiItem mCurrentPoi) {
        currentPoint = mCurrentPoi.getLatLonPoint();
