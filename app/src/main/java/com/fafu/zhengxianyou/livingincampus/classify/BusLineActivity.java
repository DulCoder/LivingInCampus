...
import com.fafu.zhengxianyou.livingincampus.adapter.travel.BusLineAdapter;
import com.fafu.zhengxianyou.livingincampus.config.Config;
import com.fafu.zhengxianyou.livingincampus.overlay.BusLineOverlay;
...
public class BusLineActivity extends Activity implements OnMarkerClickListener,
	...
	private String[] itemCitys = { "福州-0591", "苏州-0512", "杭州-0571","上海-021","合肥-0551","南京-025","蚌埠-0552","南通-0513" };
...
//        MapsInitializer.sdcardDir =OffLineMapUtils.getSdCacheDir(this);
	...
	public void searchLine() {
		...
		showProgressDialog();
		String search = searchName.getText().toString().trim();//去除首尾空格
		if ("".equals(search)) {
			search = "312";
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1,
										int arg2, long arg3) {
					mOnListItemListener.onListItemClick(BusLineDialog.this,
	...
	public void onBusStationSearched(BusStationResult result, int rCode) {
		...
		if (rCode == 1000) {
			if (result != null && result.getPageCount() > 0
				...
				Utils.toast(BusLineActivity.this, R.string.no_result);
			}
		} else {
			Utils.showError(BusLineActivity.this, rCode);
		}
	}
